...
void main(){
	...
	vec4 norm4 = vec4(0,0,0,1);

	norm4.x = dot(r1, vec4(norm, 0));
	norm4.y = dot(r2, vec4(norm, 0));
	norm4.z = dot(r3, vec4(norm, 0));

	norm4 = view * vec4(normalize(modelInvTranspose * norm4.xyz), 0);
